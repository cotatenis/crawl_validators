...
def validate_pineapple_dom():
    main_url = "https://www.shop-pineapple.co/calcados-tenis?fq=Marca:317288"
    headers = {
    ...
    if not r.ok:
        ...
        pagination_links = dom.xpath(
            "//div[@class='pagination']//li//a[contains(@href, 'pagina=')]"
        ).getall()
        ...
        # check product page
        products_urls = [
            "https://www.shop-pineapple.co/nike-sb-dunk-low-classic-green-novo-",
            "https://www.shop-pineapple.co/nike-air-jordan-1-low-og-starfish-novo-",
            "https://www.shop-pineapple.co/nike-dunk-low-georgetown-novo-",
            "https://www.shop-pineapple.co/nike-sb-dunk-low-orange-labelwhite"
        ]
        ...
        feature_product_detail = product_dom.xpath(
            "//h1[contains(@class, 'nome-produto')]/text()"
        ).getall()
